...
void RGBMeterAudioProcessorEditor::resized()
{
  ...
  lowEnableButton.setBounds(audioProcessor.rgbMeter.getX(), audioProcessor.rgbMeter.getY() + audioProcessor.rgbMeter.getHeight() + 10, audioProcessor.rgbMeter.getWidth() / 3, 20);
